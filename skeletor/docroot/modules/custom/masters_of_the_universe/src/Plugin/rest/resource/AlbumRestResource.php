...
class AlbumRestResource extends ResourceBase {
  ...
  public function get() {
    ...
    try {
      // Didn't build out a query, so just returning dummy data.
      $albums = [
        [
          'title' => 'Blonde on Blonde',
          'field_artist' => 'Bob Dylan',
        ],
        [
          'title' => 'Pet Sounds',
          'field_artist' => 'Beach Boys',
        ],
        [
          'title' => 'Aladdin Sane',
          'field_artist' => 'David Bowie',
        ],
        [
          'title' => 'Rain Dogs',
          'field_artist' => 'Tom Waits',
        ],
      ];
      return new ResourceResponse(['albums' => $albums]);
    }
    catch (\Exception $e) {
      throw new BadRequestHttpException('Bad!', $e);
    }
  }
